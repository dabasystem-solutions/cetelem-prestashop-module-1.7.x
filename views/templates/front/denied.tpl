...
{capture name=path}{l s='Cetelem denied' mod='cetelem'}{/capture}
<section id="deniedblock" class="container">
    <h3 class="col-md-10 col-md-offset-1">{l s='Your order on %s is denied.' sprintf=[$shop.name] mod='cetelem'}</h3>
